...
class DashboardViewTest(TestCase):
    ...
    def test_dashboard_shows_liked_status(self):
        response = self.client.get(self.url)
        pets = response.context['pets']
